...
echo ""
echo "============="
# this block of code runs a search for all files on the root dirrectory
#after waiting for the search, it then looks at the result with the executable function, sorts it by size,
# makes them human readable numbers for file sizes. It then ensures that only the first 12 results are displayed
echo "Largest Files on System"
echo "============="
find / -type f -exec ls -laSh 2>/dev/null {} + |head -12
echo " "
echo "============="
